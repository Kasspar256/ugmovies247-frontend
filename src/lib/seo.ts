...
const SEO_YEAR_RANGE = Array.from({ length: 6 }, (_, index) => 2025 + index);
const VJ_JUNIOR_YEAR_KEYWORDS = SEO_YEAR_RANGE.flatMap((year) => [
  `vj junior translated full movies ${year}`,
  `vj junior movies ${year} new`,
  `vj junior movies ${year}`,
  `vj junior ${year}`,
  `vj junior movies ${year} new adventure`,
  `VJ Junior Translated Movie ${year} - Friday Movie`,
  `translated movies by vj junior ${year} action`,
  `translated movies by vj junior ${year} high school`,
  `translated movies by vj junior ${year}`,
  `translated movies by vj junior ${year} inspirational movies`,
  `translated movies by vj junior ${year} hd`,
  `translated movies by vj junior ${year} sci fi`,
  `translated movies by vj junior ${year} comedy`,
]);
const HIGH_INTENT_VJ_KEYWORDS = [
  'vj junior',
  'Vj Junior',
  'VJ Junior',
  'vj jingo',
  ...
  'Vj Translated Movies',
  'VJ Translated Movies',
  'vj junior horror movies',
  'vj junior high school movies',
];
...
const FULL_SITE_KEYWORDS = [
  ...
  'Luganda translated movies download',
  'download Luganda translated movies',
  'watch translated movies in Uganda',
  'new translated movies Uganda',
  'latest VJ translated movies',
  ...
  'Best Movies UG',
  'Wanjaga movies',
  'Film translated movies Uganda',
  ...HIGH_INTENT_VJ_KEYWORDS,
  ...VJ_JUNIOR_YEAR_KEYWORDS,
  'VJ Ice P movies',
  'VJ Ulio movies',
  'VJ Soul movies',
  'VJ Uncle T movies',
  'VJ Mark movies',
  'VJ Junior latest movies',
  'VJ Emmy latest movies',
  'VJ Jingo latest movies',
