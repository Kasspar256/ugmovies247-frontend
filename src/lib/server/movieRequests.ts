...
function mapMovieRequestDoc(
  ...
  return {
    ...
    adminAlertUpdatedAt: normalizeString(data.adminAlertUpdatedAt),
    adminFcmAlertStatus: normalizeString(data.adminFcmAlertStatus),
    adminFcmAlertReason: normalizeString(data.adminFcmAlertReason),
    adminTelegramAlertStatus: normalizeString(data.adminTelegramAlertStatus),
    adminTelegramAlertReason: normalizeString(data.adminTelegramAlertReason),
